...
export function DocumentUpload() {
  ...
  const handleSummarize = () => {
    ...
    // Simulating document analysis delay
    setTimeout(() => {
      setSummary(`Summary of ${selectedFile.name}: This document contains important insights about XYZ.`);
      setLoading(false);
    }, 2000);
  };
    ...
    <div className="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
      <div className="p-6">
        ...
        {!summary ? (
          ...
          <Summary summary={summary} loading={loading} onReset={handleReset} />
        )}
      </div>
    </div>
  );
